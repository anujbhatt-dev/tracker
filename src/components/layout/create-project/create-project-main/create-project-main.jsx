      ...
      return (
          <div className="createProjectMain">
              <div className="createProjectMain__col1">
                 <input className="createProjectMain__col1_input createProjectMain__col1_input--text" value={this.props.projectName} onChange={e=>this.props.updateHandler(e)} placeholder="Project name" name="projectName" type="text"/><br/>
                 <input className="createProjectMain__col1_input createProjectMain__col1_input--text" value={this.props.projectId} onChange={e=>this.props.updateHandler(e)} placeholder="project Id" name="projectId" type="text"/><br/>
